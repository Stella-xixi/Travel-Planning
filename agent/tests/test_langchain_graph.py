...
from graph.builder import TravelAgentGraph, build_travel_planning_agent_runtime
...
class TestTravelAgentGraph:
    ...
    def test_build_travel_planning_agent_runtime(self, mock_llm, mock_tools):
        """测试 Agent 构建"""
        agent = build_travel_planning_agent_runtime(mock_llm, mock_tools)
