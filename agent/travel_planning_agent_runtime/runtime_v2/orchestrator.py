...
from travel_planning_contracts.common import ArtifactType
...
class LocalA2AAgentMesh:
    ...
    def deterministic_dispatch_id(
        ...
        scope = f"travel-planning-v1\x1f{tenant_id}\x1f{run_id}\x1f{interface_id}\x1f{dispatch_key}"
        ...
        *,
        ...
        message_id = str(
            uuid5(
                ...
                f"travel-planning-v1-resume\x1f{task.id}\x1f{response_key}",
            )
        )
        payload = {
            "tenant": actor.tenant_id,
