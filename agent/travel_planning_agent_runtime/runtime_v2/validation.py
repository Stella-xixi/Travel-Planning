...
from travel_planning_contracts.common import ArtifactType, FreshnessStatus, Severity, VersionedComponent
...
class DeterministicConstraintValidator:
    ...
    def validate(
        ...
        return ConstraintReport(
            ...
            checked_at=utc_now(),
            engine=VersionedComponent(name="Travel-Planning Constraint Validator", version=self.version),
            outcome=outcome,
            checks=checks,
...
class DeterministicSemanticVerifier:
    ...
    def verify(self, plan: ItineraryPlan, evidence: EvidenceBundle) -> SemanticRiskReport:
        ...
        return SemanticRiskReport(
            ...
            timezone=plan.timezone,
            assessed_at=utc_now(),
            reviewer=VersionedComponent(name="Travel-Planning Semantic Verifier", version=self.version),
