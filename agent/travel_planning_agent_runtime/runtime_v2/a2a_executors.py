...
from travel_planning_agent_runtime.a2a.registry import AgentExecutor
...
DEFAULT_RAG_CORPUS_REVISION = "travel-planning-travel-zh@2026.07.2"
    ...
    def __init__(
        ...
        *,
        ...
        self.corpus_revision: str = corpus_revision or os.getenv(
            "TRAVEL_PLANNING_RAG_CORPUS_REVISION",
