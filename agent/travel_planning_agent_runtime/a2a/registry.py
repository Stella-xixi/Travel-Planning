"""Curated local registry for trusted Travel-Planning A2A agent interfaces."""
        ...
        capabilities=AgentCapabilities(
            ...
            extensions=[
                AgentExtension(
                    ...
                    description=(
                        "Versioned Travel-Planning travel artifacts and reliable dispatch metadata."
                    ),
                    required=True,
                )
            ],
...
def build_default_registry(
    *,
    ...
    resolved_base_url = cast(
        ...
        base_url
        or os.getenv(
            "TRAVEL_PLANNING_A2A_PUBLIC_BASE_URL",
    ...
    specifications = (
        (
            "answering",
            "Travel-Planning Answering Agent",
        ...
        (
            "research",
            "Travel-Planning Research Agent",
        ...
        (
            "validation",
            "Travel-Planning Validation Service Agent",
        ...
        (
            "semantic-verifier",
            "Travel-Planning Semantic Verifier Agent",
