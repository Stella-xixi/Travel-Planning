...
class StrictModel(BaseModel):
    """Reject unknown fields at the Travel-Planning A2A application boundary."""
...
class DispatchMetadata(StrictModel):
    """Travel-Planning extension metadata required on an initial A2A dispatch."""
...
def default_contract_validator(contract: str, payload: dict[str, Any]) -> Any:
    ...
    try:
        ...
        from packages.python.travel_planning_contracts.src.travel_planning_contracts.validation import (
            validate_contract,
        )
