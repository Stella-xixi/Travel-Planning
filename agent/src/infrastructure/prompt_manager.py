...
manager.load_from_dict("travel_planning_agent_runtime", {...})
prompt = manager.render("travel_planning_agent_runtime", {"city": "北京"})
```
...
class PromptManager:
    ...
    def _load_builtin_templates(self) -> None:
        ...
        self.add(PromptTemplate(
            name="travel_planning_agent_runtime_system",
