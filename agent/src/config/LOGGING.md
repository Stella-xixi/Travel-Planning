...
### 控制台输出（标准格式）
```
[2024-01-15 14:30:45.123] INFO     | agent.core.travel_planning_agent_runtime | User request received:我想去北京旅游
```

### 文件输出（详细格式，包含行号和函数名）
```
[2024-01-15 14:30:45.123] INFO     | agent.core.travel_planning_agent_runtime:123 | process_request() | User request received:我想去北京旅游
```

### JSON 格式（日志聚合）
```json
{"timestamp": "2024-01-15 14:30:45.123", "level": "INFO", "logger": "agent.core.travel_planning_agent_runtime", "message": "User request received", "module": "travel_planning_agent_runtime", "function": "process_request", "line": 123}
```
