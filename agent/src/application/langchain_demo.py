...
async def main():
    ...
    from graph import build_travel_planning_agent_runtime, run_travel_planning_agent_runtime, create_initial_state
    ...
    for i, user_input in enumerate(test_cases, 1):
        ...
        # 方式1: 使用 run_travel_planning_agent_runtime 便捷函数
