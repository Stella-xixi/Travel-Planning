"""Command line interface for the Travel-Planning V1 migration toolset."""
...
def _add_source_arguments(parser: argparse.ArgumentParser) -> None:
    ...
    parser.add_argument(
        "--source-database-url",
        default=os.getenv("TRAVEL_PLANNING_LEGACY_DATABASE_URL", "").strip() or None,
        help="Read-only legacy SQLAlchemy URL. Defaults to TRAVEL_PLANNING_LEGACY_DATABASE_URL.",
    )
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        description="Fail-closed offline import of read-only Travel-Planning V1 archives.",
    )
    ...
    migrate.add_argument("--target-database-url", default=os.getenv("TRAVEL_PLANNING_V1_DATABASE_URL", ""))
    ...
    reconcile.add_argument("--target-database-url", default=os.getenv("TRAVEL_PLANNING_V1_DATABASE_URL", ""))
