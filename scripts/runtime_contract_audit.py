...
CONTRACT_PATH = ROOT / "agent" / "travel_planning_agent_runtime" / "contracts" / "supervisor_orchestration.py"
LEGACY_BRIDGE_PATH = ROOT / "agent" / "travel_planning_agent_runtime" / "runtime" / "legacy_bridge.py"
LEGACY_RUNTIME_PATH = ROOT / "agent" / "travel_planning_agent_runtime" / "graph" / "legacy_runtime.py"
RUNTIME_SOURCES_PATH = ROOT / "agent" / "travel_planning_agent_runtime" / "runtime_sources.py"
RUNTIME_EVENT_EMITTERS_PATH = ROOT / "agent" / "travel_planning_agent_runtime" / "runtime_event_emitters.py"
AGENT_RUNTIME_PATH = ROOT / "agent" / "travel_planning_agent_runtime" / "runtime" / "agent_runtime.py"
