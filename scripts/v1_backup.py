"""Create and verify restricted Travel-Planning V1 PostgreSQL logical backups."""
...
def create_backup(
    *,
    ...
    backup = output_dir / f"travel-planning-{timestamp}.dump"
...
def main() -> int:
    ...
    parser.add_argument("--project-name", default="travel-planning-v1")
