...
if TYPE_CHECKING:
    from travel_planning_agent_runtime.memory.postgres_memory_session_repository import PostgresMemorySessionRepository
    from travel_planning_api.repositories.postgres_share_link_repository import PostgresShareLinkRepository
    from travel_planning_api.repositories.session_repository_postgres import PostgresSessionRepository
...
def _load_sql_runtime_dependencies():
    ...
    from travel_planning_agent_runtime.memory.postgres_memory_session_repository import PostgresMemorySessionRepository
    from travel_planning_api.persistence import build_sync_engine, ensure_schema
    from travel_planning_api.repositories.postgres_share_link_repository import PostgresShareLinkRepository
    from travel_planning_api.repositories.session_repository_postgres import PostgresSessionRepository
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--database-url",
        default=os.getenv("TRAVEL_PLANNING_POSTGRES_DSN", "").strip(),
        help="Target database URL. Defaults to TRAVEL_PLANNING_POSTGRES_DSN.",
    )
    parser.add_argument(
        "--sessions-file",
        type=Path,
