...
from travel_planning_api.repositories.file_session_repository import FileSessionRepository


def resolve_checkpointer_config(**kwargs):
    """Lazily load checkpoint config resolver so prune stays lightweight."""

    from travel_planning_agent_runtime.runtime_sources import resolve_checkpointer_config as _resolve_checkpointer_config
...
def create_checkpointer(config):
    ...
    from travel_planning_agent_runtime.runtime_sources import create_checkpointer as _create_checkpointer
...
def close_checkpointer(checkpointer) -> None:
    ...
    from travel_planning_agent_runtime.runtime_sources import close_checkpointer as _close_checkpointer
