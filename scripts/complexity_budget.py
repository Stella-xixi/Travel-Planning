...
DEFAULT_TARGETS: tuple[BudgetTarget, ...] = (
    BudgetTarget("agent/travel_planning_agent_runtime/graph/nodes.py", "legacy graph execution hotspot"),
    BudgetTarget(
        "agent/travel_planning_agent_runtime/graph/memory_integration.py",
        "legacy memory orchestration hotspot",
    ),
    BudgetTarget("agent/travel_planning_agent_runtime/graph/builder.py", "runtime graph assembly hotspot"),
    BudgetTarget("agent/travel_planning_agent_runtime/tools/travel_api.py", "large external travel provider adapter"),
    BudgetTarget("agent/travel_planning_agent_runtime/tools/travel_tools.py", "large tool aggregation module"),
    BudgetTarget(
        "agent/travel_planning_agent_runtime/memory/conflict_resolution.py",
        "memory conflict clarification helper",
    ),
    BudgetTarget("agent/travel_planning_agent_runtime/pipelines/planning.py", "planning pipeline hotspot"),
    BudgetTarget(
        "backend/travel_planning_api/services/chat/stream_mixin.py",
        "chat streaming orchestration hotspot",
    ),
    BudgetTarget("backend/travel_planning_api/routes/api_docs.py", "API docs presentation route"),
