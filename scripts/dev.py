...
STATIC_TARGETS = (
    ...
    "backend/travel_planning_api/app_meta.py",
    "backend/travel_planning_api/main.py",
    "backend/travel_planning_api/middleware/__init__.py",
    "backend/travel_planning_api/observability.py",
    "backend/travel_planning_api/routes/chat.py",
    "backend/travel_planning_api/routes/health.py",
    "backend/travel_planning_api/services/share_service.py",
    "backend/travel_planning_api/startup_checks.py",
)
HELP_TEXT = """Usage:
