...
from travel_planning_contracts.artifacts import ConstraintSpec, TravelPreference, TripBrief
from travel_planning_contracts.common import ActorRef, MoneyRange, TripDateRange
