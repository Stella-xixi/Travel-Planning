...
1. Import [`grafana-dashboard.json`](/D:/moyuan/Travel-Planning/ops/observability/grafana-dashboard.json) into Grafana.
2. Load [`prometheus-alerts.yml`](/D:/moyuan/Travel-Planning/ops/observability/prometheus-alerts.yml) into your Prometheus rules path.
...
- datasource `Travel-Planning Prometheus`
- dashboard `Travel-Planning Overview`
