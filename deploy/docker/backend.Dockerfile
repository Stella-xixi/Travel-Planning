...
LABEL org.opencontainers.image.title="Travel-Planning Backend" \
      org.opencontainers.image.description="FastAPI backend for Travel-Planning" \
...
CMD ["python", "-m", "uvicorn", "travel_planning_api.main:app", "--host", "0.0.0.0", "--port", "38000", "--app-dir", "backend"]
