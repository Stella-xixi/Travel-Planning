...
- provide_travel_planning_agent_runtime(): 提供旅游Agent实例
...
使用示例:
    from dependencies.providers import (
        ...
        provide_travel_planning_agent_runtime
    )
    ...
    # 获取旅游Agent
    agent = provide_travel_planning_agent_runtime()
...
def provide_travel_planning_agent_runtime():
    ...
    """
    from core.travel_planning_agent_runtime import ReActTravelAgent
