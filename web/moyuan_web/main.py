"""FastAPI entrypoint for Travel-Planning web API."""
...
from travel_planning_api.app_meta import APP_NAME, APP_VERSION, build_metadata
from travel_planning_api.bootstrap_container import initialize_dependency_container
from travel_planning_api.bootstrap import ensure_project_paths
from travel_planning_api.config.runtime import get_model_config_manager, get_server_config
from travel_planning_api.middleware import setup_middleware
from travel_planning_api.startup_checks import maybe_fail_fast_on_startup
from travel_planning_api.routes import (
    api_docs_router,
    chat_router,
    city_router,
    health_router,
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Travel-Planning Web Server")
