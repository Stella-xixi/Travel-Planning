...
from backend.travel_planning_api.v1.runtime import RunCoordinator, V1Runtime
from backend.travel_planning_api.v1.store import InMemoryPlatformStore, VersionConflict
...
def build_artifact_app() -> tuple[FastAPI, InMemoryPlatformStore]:
    ...
    app.state.travel_planning_v1_runtime = V1Runtime(
        store=store,
