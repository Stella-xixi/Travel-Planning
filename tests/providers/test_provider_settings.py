...
from travel_planning_agent_runtime.providers import ProviderSettings


def test_settings_ignore_deprecated_key_alias_and_redact_canonical_secret(
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    monkeypatch.delenv("TRAVEL_PLANNING_AMAP_WEB_KEY", raising=False)
    monkeypatch.delenv("TRAVEL_PLANNING_PROVIDER_ALLOWLIST", raising=False)
...
def test_settings_reject_unknown_allowlisted_provider(
    ...
    monkeypatch.setenv("TRAVEL_PLANNING_PROVIDER_ALLOWLIST", "amap,typo-provider")
