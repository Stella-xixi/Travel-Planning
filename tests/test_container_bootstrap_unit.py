...
from travel_planning_api.repositories.file_session_repository import FileSessionRepository  # noqa: E402
from travel_planning_api.repositories.postgres_share_link_repository import PostgresShareLinkRepository  # noqa: E402
from travel_planning_api.repositories.session_repository_postgres import PostgresSessionRepository  # noqa: E402
from travel_planning_api.services.artifact_service import ArtifactService  # noqa: E402
from travel_planning_api.services.chat_service import ChatService  # noqa: E402
from travel_planning_api.services.city_service import CityService  # noqa: E402
from travel_planning_api.services.map_service import MapService  # noqa: E402
from travel_planning_api.services.share_service import ShareService  # noqa: E402
...
def test_build_default_container_resolves_postgres_backends_when_configured(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("TRAVEL_PLANNING_DB_BACKEND", "postgres")
    monkeypatch.setenv("TRAVEL_PLANNING_POSTGRES_DSN", database_url)
    monkeypatch.setenv("TRAVEL_PLANNING_DB_POOL_MIN", "1")
    monkeypatch.setenv("TRAVEL_PLANNING_DB_POOL_MAX", "2")
    ...
    try:
        ...
        monkeypatch.delenv("TRAVEL_PLANNING_DB_BACKEND", raising=False)
        monkeypatch.delenv("TRAVEL_PLANNING_POSTGRES_DSN", raising=False)
        monkeypatch.delenv("TRAVEL_PLANNING_DB_POOL_MIN", raising=False)
        monkeypatch.delenv("TRAVEL_PLANNING_DB_POOL_MAX", raising=False)
        server_config.reload()
