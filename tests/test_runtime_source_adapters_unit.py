...
from travel_planning_agent_runtime.contracts import (
    SupervisorPlanPreviewRequest,
    SupervisorRunRequest,
    SupervisorRuntimeContext,
)
from travel_planning_agent_runtime.runtime_sources import (
    GraphRuntimeSource,
    PlanPreviewSource,
...
def test_build_memory_graph_source_prepares_state_and_graph(monkeypatch):
    ...
    def _fake_build_travel_planning_agent_runtime(llm, tools, system_prompt, *, checkpointer, routing_llm):
    ...
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.get_agent_memory_manager", _fake_get_agent_memory_manager)
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.AgentStateWithMemory.create", _fake_create)
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.build_travel_planning_agent_runtime", _fake_build_travel_planning_agent_runtime)
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.create_default_checkpointer", lambda: checkpointer)
...
def test_build_memory_plan_preview_source_prepares_nodes_and_state(monkeypatch):
    ...
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.AgentStateWithMemory.create", _fake_create)
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.AgentNodes", _fake_agent_nodes)
...
def test_supervisor_source_builders_forward_resolved_contract_inputs(monkeypatch):
    ...
    monkeypatch.setattr("travel_planning_agent_runtime.runtime_sources.build_memory_graph_source", _fake_build_memory_graph_source)
    monkeypatch.setattr(
        "travel_planning_agent_runtime.runtime_sources.build_memory_plan_preview_source",
