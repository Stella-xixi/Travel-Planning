...
from travel_planning_agent_runtime.graph.nodes import AgentNodes, _resolve_parallelism_default
from travel_planning_agent_runtime.graph.prompt_templates import build_answer_prompt
...
def test_travel_planning_agent_runtime_astream_events_uses_v2(monkeypatch):
...
def test_travel_planning_agent_runtime_invoke_falls_back_to_async_invoke():
    class DummyCompiledGraph:
        def __init__(self):
            self.sync_calls = 0
            self.async_calls = 0
