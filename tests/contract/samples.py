...
def source(
    ...
    *,
    kind: str = "rag",
    name: str = "Travel-Planning knowledge base",
...
def build_valid_contracts() -> dict[str, dict[str, Any]]:
    ...
    constraint_report = {
        **artifact_header("ConstraintReport", "constraints_001"),
        ...
        "timezone": TIMEZONE,
        "checked_at": NOW,
        "engine": {"name": "Travel-Planning ValidationService", "version": "1.0.0"},
        "outcome": "pass",
        "checks": [
            {
    ...
    semantic_report = {
        **artifact_header("SemanticRiskReport", "semantic_001"),
        ...
        "timezone": TIMEZONE,
        "assessed_at": NOW,
        "reviewer": {"name": "Travel-Planning Verifier", "version": "verifier-v1"},
