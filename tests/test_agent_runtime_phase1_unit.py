...
from travel_planning_agent_runtime.artifacts import (
    build_trip_plan_artifact_from_plan_preview,
    build_trip_plan_artifact_from_state,
)
from travel_planning_agent_runtime.runtime.agent_runtime import AgentRuntime
from travel_planning_agent_runtime.skills import build_default_skill_registry
...
def test_agent_runtime_enriches_done_stream_event(monkeypatch):
    ...
    monkeypatch.setattr("travel_planning_agent_runtime.runtime.agent_runtime.run_travel_planning_agent_runtime_streaming_with_memory", _fake_stream)
...
def test_agent_runtime_preview_attaches_artifact(monkeypatch):
    ...
    monkeypatch.setattr(
        "travel_planning_agent_runtime.runtime.agent_runtime.generate_plan_preview_with_memory",
        lambda **kwargs: {
            "plan_id": "preview-2",
            "intent": "itinerary",
