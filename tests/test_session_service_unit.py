...
from travel_planning_api.services.session_service import SessionService  # noqa: E402
...
async def test_session_service_builds_default_memory_manager_lazily(monkeypatch):
    ...
    monkeypatch.setattr(
        "travel_planning_api.services.session_service.build_default_memory_manager",
