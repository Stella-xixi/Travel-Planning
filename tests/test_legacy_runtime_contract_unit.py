...
from travel_planning_agent_runtime.graph import legacy_runtime
from travel_planning_agent_runtime.runtime.legacy_bridge import DefaultLegacyRuntimeBridge
...
def test_stream_supervisor_run_uses_explicit_contract(monkeypatch):
    ...
    async def _fake_run_travel_planning_agent_runtime_streaming_with_memory(**kwargs):
    ...
    monkeypatch.setattr(
        ...
        _fake_run_travel_planning_agent_runtime_streaming_with_memory,
    )
