...
from travel_planning_agent_runtime.a2a.constants import MAX_PERSISTED_TASK_PROTO_BYTES
from travel_planning_agent_runtime.a2a.models import AgentInvocation, ArtifactInput
from travel_planning_agent_runtime.a2a.postgres_store import (
...
from travel_planning_agent_runtime.a2a.store import (
...
from backend.travel_planning_api.v1.a2a_routes import build_default_a2a_runtime
...
def test_database_url_normalization_and_production_fail_closed(monkeypatch):
    ...
    monkeypatch.delenv("TRAVEL_PLANNING_A2A_DATABASE_URL", raising=False)
    monkeypatch.delenv("TRAVEL_PLANNING_V1_DATABASE_URL", raising=False)
...
async def test_database_url_uses_postgres_adapter_and_runtime_closes_it(monkeypatch):
    ...
    monkeypatch.setenv("TRAVEL_PLANNING_A2A_DATABASE_URL", "postgresql://db/a2a")
    monkeypatch.delenv("TRAVEL_PLANNING_V1_DATABASE_URL", raising=False)
