...
from travel_planning_agent_runtime.a2a.constants import (
...
from travel_planning_agent_runtime.a2a.models import (
    A2AActor,
    ArtifactOutput,
    CompletedExecution,
    InputField,
...
from travel_planning_agent_runtime.a2a.registry import build_default_registry
from travel_planning_agent_runtime.a2a.service import TaskService
from travel_planning_agent_runtime.a2a.store import InMemoryAgentTaskStore
from backend.travel_planning_api.v1.a2a_routes import (
    A2ARuntime,
...
def build_app(executor: Any, *, authenticated: bool = True) -> tuple[FastAPI, A2ARuntime]:
    ...
    dispatchers = {
        profile.interface_id: JsonRpcDispatcher(
            TravelPlanningA2ARequestHandler(profile.interface_id, registry, service),
    ...
    app.state.travel_planning_v1_a2a_runtime = runtime
    if authenticated:
        ...
        app.state.travel_planning_v1_authenticator = authenticate
    return app, runtime
