...
from travel_planning_agent_runtime.a2a.models import A2AActor, InputResponse
...
async def test_postgres_a2a_create_dedupe_cas_event_replay_and_tenant_scope():
    dsn = os.getenv("TRAVEL_PLANNING_A2A_TEST_DSN", "").strip()
    if not dsn:
        pytest.skip("TRAVEL_PLANNING_A2A_TEST_DSN is not configured")
