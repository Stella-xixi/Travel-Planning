...
from backend.travel_planning_api.v1.models import Principal, RunLifecycle
from backend.travel_planning_api.v1.routes import router
...
from travel_planning_contracts import validate_run_event
...
def build_test_app(executor: FakeWholeRunExecutor, *, authenticated: bool = True) -> FastAPI:
    ...
    app.state.travel_planning_v1_runtime = runtime
