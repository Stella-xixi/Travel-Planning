...
from travel_planning_agent_runtime.runtime_v2.a2a_executors import (
    PlannerA2AExecutor,
...
from travel_planning_agent_runtime.runtime_v2.orchestrator import LocalA2AAgentMesh, TravelOrchestratorV2
...
from travel_planning_contracts.common import (
    ActorRef,
    ArtifactRef,
    ArtifactType,
    Citation,
...
def source(source_id: str = "source:test") -> SourceRef:
    return SourceRef(
        ...
        version="revision-1",
        retrieved_at=NOW,
        publisher="Travel-Planning tests",
        license="CC-BY-4.0",
    )
