...
from travel_planning_agent_runtime.a2a.models import AgentExecutionContext
...
from travel_planning_agent_runtime.runtime_v2 import ProviderRouteService
from travel_planning_agent_runtime.runtime_v2.a2a_executors import (
    PlannerA2AExecutor,
    ResearchA2AExecutor,
    build_core_a2a_executors,
)
from travel_planning_contracts.artifacts import Candidate
