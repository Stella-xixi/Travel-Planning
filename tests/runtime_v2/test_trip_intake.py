...
from travel_planning_agent_runtime.a2a.models import AgentExecutionContext, AgentInvocation, ArtifactInput
...
from travel_planning_agent_runtime.runtime_v2.a2a_executors import ResearchA2AExecutor
from travel_planning_contracts import validate_contract
...
class FakeUnavailableGeocoder(FakeGeocoder):
    async def geocode(self, request, context):
        del request, context
        from travel_planning_agent_runtime.providers import ProviderAuthenticationError
...
async def test_trip_intake_uses_approved_city_catalog_when_live_geocoder_is_down() -> None:
    ...
    assert brief.destination.source.publisher == "travel-planning-destination-catalog"
