"""Tests for atomic, private Travel-Planning backup artifacts."""
...
def test_backup_creation_is_atomic_private_and_manifest_bound(
    ...
    backup = v1_backup.create_backup(
        ...
        project_name="travel-planning-v1",
        now=now,
    )

    assert backup.name == "travel-planning-20260713T083000Z.dump"
...
def test_backup_rejects_broad_permissions_and_tampering(
    ...
    backup = secure / "travel-planning.dump"
