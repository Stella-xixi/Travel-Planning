...
from travel_planning_agent_runtime.graph.postgres_checkpointer import PersistentPostgresSaver
...
def test_persistent_postgres_saver_recovers_multi_turn_session(tmp_path: Path):
    ...
    agent_1 = build_travel_planning_agent_runtime(
        llm=FakeLLM(),
        tools=[],
    ...
    agent_2 = build_travel_planning_agent_runtime(
        llm=FakeLLM(),
        tools=[],
        system_prompt=TRAVEL_AGENT_SYSTEM_PROMPT,
