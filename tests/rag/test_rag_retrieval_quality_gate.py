...
from travel_planning_agent_runtime.rag.models import LicenseMetadata, utc_now
...
GOLDEN: tuple[tuple[str, str, str], ...] = (
    (
        "紫禁城哪天不开放",
        "https://knowledge.travel-planning.test/beijing/forbidden-city-hours",
        "故宫博物院每周一闭馆；法定节假日安排以官方公告为准。",
    ),
    (
        "轮椅游览皇家园林怎么走",
        "https://knowledge.travel-planning.test/beijing/summer-palace-accessibility",
        "颐和园东宫门设有无障碍入口，轮椅游客可优先选择平缓的昆明湖东岸路线。",
    ),
    (
        "去长城坐哪趟火车",
        "https://knowledge.travel-planning.test/beijing/badaling-rail",
        "前往八达岭长城可从北京北站乘坐市郊铁路 S2 线，班次以铁路公告为准。",
    ),
    (
        "下雨天适合看文物的室内地点",
        "https://knowledge.travel-planning.test/beijing/rainy-museum",
        "首都博物馆是室内文博场馆，雨天可安排常设展览并提前预约。",
    ),
    (
        "老人想少走路看天坛",
        "https://knowledge.travel-planning.test/beijing/temple-of-heaven-senior",
...
class GoldenSemanticEmbedding:
    ...
    model_id = "travel-planning-rag-quality-fixture"
...
async def test_hybrid_retrieval_meets_fixed_recall_and_citation_precision_gate() -> None:
    ...
    license_metadata = LicenseMetadata(
        ...
        license_url="https://knowledge.travel-planning.test/license",
