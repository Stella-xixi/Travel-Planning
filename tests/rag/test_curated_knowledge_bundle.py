...
from travel_planning_agent_runtime.runtime_v2.a2a_executors import DEFAULT_RAG_CORPUS_REVISION
from scripts.v1_knowledge_base import apply_bundle, bundle_plan, verify_bundle

REPOSITORY_ROOT = Path(__file__).resolve().parents[2]
BUNDLE_ROOT = (
    REPOSITORY_ROOT
    / "agent/travel_planning_agent_runtime/rag/curated/travel-planning-travel-basics-zh"
)
...
def test_builtin_bundle_is_checksum_bound_reviewed_and_replay_stable() -> None:
    ...
    assert bundle.manifest.bundle_id == "travel-planning-travel-basics-zh"
