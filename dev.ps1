...
$staticTargets = @(
    ...
    "web/travel_planning_api/app_meta.py",
    "web/travel_planning_api/main.py",
    "web/travel_planning_api/middleware/__init__.py",
    "web/travel_planning_api/observability.py",
    "web/travel_planning_api/routes/chat.py",
    "web/travel_planning_api/routes/health.py",
    "web/travel_planning_api/services/share_service.py",
    "web/travel_planning_api/startup_checks.py"
)
