...
| ReActTravelAgent | `src/core/travel_planning_agent_runtime.py` | 旅游领域Agent封装 |
...
│   │   └── travel_planning_agent_runtime.py   # 旅游Agent封装
│   ├── llm/                  # LLM相关
...
3. 在 `agent/src/core/travel_planning_agent_runtime.py` 注册工具
