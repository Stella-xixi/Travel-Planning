  ...
  return (
    <main className="landing-page">
      <header className="site-header constrained">
        <Link href="/" className="brand" aria-label="Travel-Planning 首页">
      ...
      <section className="landing-hero constrained">
        <div className="hero-copy">
          ...
          <p>不用先整理攻略，也不用先创建复杂项目。告诉 Travel-Planning 你想去哪里、和谁去或正在纠结什么，多个专业 Agent 会协作研究、规划与核验。</p>
          <HomeQuickStart />
          <div className="hero-trust"><span><Icons.Check /> 关键事实有来源</span><span><Icons.Check /> 只追问必要信息</span><span><Icons.Check /> 方案可继续修改</span></div>
        </div>
        <div className="hero-visual" aria-label="Travel-Planning 旅行问答预览">
          ...
          <div className="answer-preview">
            ...
            <div className="preview-answer">
              ...
              <p>Travel-Planning 会把结论、理由和仍需核验的信息分开呈现，不用先读完一整篇攻略。</p>
