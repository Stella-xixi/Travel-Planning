...
function authHeaders(request: NextRequest): HeadersInit {
  ...
  if (config.developmentIdentity) {
    return {
      "X-Travel-Planning-Dev-Tenant": config.developmentIdentity.tenant,
      "X-Travel-Planning-Dev-User": config.developmentIdentity.user,
      "X-Travel-Planning-Dev-Roles": config.developmentIdentity.roles,
      "X-Travel-Planning-Dev-BFF-Secret": config.developmentIdentity.sharedSecret,
    };
  }
