    ...
    <main className="trips-page">
      ...
      <section className="trips-hero constrained">
        <div>
          ...
          <h1>从一个真实的旅行问题开始</h1>
          <p>不用给项目起名字，也不用先整理完整需求。直接说你的想法，Travel-Planning 会保留上下文，并只补问生成可靠答案所需的信息。</p>
        </div>
      ...
      <section className="trip-library constrained" aria-labelledby="trip-library-title">
        <div className="section-heading">
          <div>
            ...
            <p>{showArchived ? "随时恢复，不丢失历史版本。" : visibleTrips.length ? "继续追问、调整行程或查看正式方案。" : "Travel-Planning 会把问题、约束、证据和最终方案保存在同一个上下文中。"}</p>
          </div>
