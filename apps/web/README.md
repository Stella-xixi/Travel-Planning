# Travel-Planning Web V1

The single, artifact-first Travel-Planning product UI. It talks only to its same-origin
...
The end-user flow is documented in the [Travel-Planning user guide](../../docs/product/user-guide.md).
